...
Report bugs at https://github.com/portugueslab/{{ cookiecutter.project_slug }}/issues.
...
The best way to send feedback is to file an issue at https://github.com/portugueslab/{{ cookiecutter.project_slug }}/issues.
...
#### Formatting
{{ cookiecutter.project_name}} uses [Black](https://github.com/python/black) to ensure a consistent
